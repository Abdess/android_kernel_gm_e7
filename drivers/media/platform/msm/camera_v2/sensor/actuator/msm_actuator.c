...
#ifndef GN_MACH_MSM8974_NBL8910A_CAMERA_SUPPORT
			} else {
...
static int32_t read_otp(struct gn_sunny_imx135_otp_struct *otp_ptr)
{
	...
	otp_ptr->gxzoom_otp = ((read_cmos_sensor_byte_data(ois_info_addr + 0x19) << 24) & 0xff000000) | ((read_cmos_sensor_byte_data(ois_info_addr + 0x1a) << 16) & 0xff0000) | ((read_cmos_sensor_byte_data(ois_info_addr + 0x1b) << 8) & 0xff00) | (read_cmos_sensor_byte_data(ois_info_addr + 0x1c) & 0xff);

	otp_ptr->gyzoom_otp = ((read_cmos_sensor_byte_data(ois_info_addr + 0x1d) << 24) & 0xff000000) | ((read_cmos_sensor_byte_data(ois_info_addr + 0x1e) << 16) & 0xff0000) | ((read_cmos_sensor_byte_data(ois_info_addr + 0x1f) << 8) & 0xff00) | (read_cmos_sensor_byte_data(ois_info_addr + 0x20) & 0xff);
